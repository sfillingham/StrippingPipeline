...
def KHwork(tq, check):
    ...
    ABdata1 = Table.read('stripdata/RPS_strippedfrac_hot40_v300_AB.dat', format = 'ascii')
    ABmstar1 = np.array(ABdata1['Mstar'])
    ABfrac1 = np.array(ABdata1['NFW'])
    KH1 = np.array(ABdata1['KH_1Gyr'])

    ABdata2 = Table.read('stripdata/RPS_strippedfrac_hot35_v300_AB.dat', format = 'ascii')
    ABmstar2 = np.array(ABdata2['Mstar'])
    ABfrac2 = np.array(ABdata2['NFW'])
    KH2 = np.array(ABdata2['KH_1Gyr'])

    ABdata3 = Table.read('stripdata/RPS_strippedfrac_hot32_v300_AB.dat', format = 'ascii')
    ABmstar3 = np.array(ABdata3['Mstar'])
    ABfrac3 = np.array(ABdata3['NFW'])
    KH3 = np.array(ABdata3['KH_1Gyr'])

    ABdata4 = Table.read('stripdata/RPS_strippedfrac_hot30_v300_AB.dat', format = 'ascii')
    ABmstar4 = np.array(ABdata4['Mstar'])
    ABfrac4 = np.array(ABdata4['NFW'])
    KH4 = np.array(ABdata4['KH_1Gyr'])

    ABdata5 = Table.read('stripdata/RPS_strippedfrac_hot27_v300_AB.dat', format = 'ascii')
    ABmstar5 = np.array(ABdata5['Mstar'])
    ABfrac5 = np.array(ABdata5['NFW'])
    KH5 = np.array(ABdata5['KH_1Gyr'])

    ABdata6 = Table.read('stripdata/RPS_strippedfrac_hot25_v300_AB.dat', format = 'ascii')
...
###################################################
    ...
    #if check == 'normal':
        #plt.savefig('RPS_AM_6panel_KH'+np.str(tq)+'Gyr.pdf')

    #elif check == 'kh_hist':
        #plt.savefig('RPS_AM_6panel_KHonly_hist'+np.str(tq)+'Gyr_slide.pdf')

    #else:
        #plt.savefig('RPS_AM_6panel_KH_hist'+np.str(tq)+'Gyr_slide.pdf')
...
def RPSwork(check):
    ...
    ABdata1 = Table.read('stripdata/RPS_strippedfrac_hot30_v200_AB.dat', format = 'ascii')
    ABmstar1 = np.array(ABdata1['Mstar'])
    ABfrac1 = np.array(ABdata1['NFW'])
    KH1 = np.array(ABdata1['KH_1Gyr'])

    ABdata2 = Table.read('stripdata/RPS_strippedfrac_hot30_v250_AB.dat', format = 'ascii')
    ABmstar2 = np.array(ABdata2['Mstar'])
    ABfrac2 = np.array(ABdata2['NFW'])
    KH2 = np.array(ABdata2['KH_1Gyr'])

    ABdata3 = Table.read('stripdata/RPS_strippedfrac_hot30_v300_AB.dat', format = 'ascii')
    ABmstar3 = np.array(ABdata3['Mstar'])
    ABfrac3 = np.array(ABdata3['NFW'])
    KH3 = np.array(ABdata3['KH_1Gyr'])

    ABdata4 = Table.read('stripdata/RPS_strippedfrac_hot30_v350_AB.dat', format = 'ascii')
    ABmstar4 = np.array(ABdata4['Mstar'])
    ABfrac4 = np.array(ABdata4['NFW'])
    KH4 = np.array(ABdata4['KH_1Gyr'])

    ABdata5 = Table.read('stripdata/RPS_strippedfrac_hot30_v400_AB.dat', format = 'ascii')
    ABmstar5 = np.array(ABdata5['Mstar'])
    ABfrac5 = np.array(ABdata5['NFW'])
    KH5 = np.array(ABdata5['KH_1Gyr'])

    ABdata6 = Table.read('stripdata/RPS_strippedfrac_hot30_v450_AB.dat', format = 'ascii')
    ABmstar6 = np.array(ABdata6['Mstar'])
    ABfrac6 = np.array(ABdata6['NFW'])
    KH6 = np.array(ABdata6['KH_1Gyr'])
    ...
    for i in range(len(binlist)-1):
        ...
        mean1[i] = np.mean(ABfrac1[cut1])
        upper1[i] = np.mean(ABfrac1[cut1]) + np.std(ABfrac1[cut1])
        lower1[i] = np.mean(ABfrac1[cut1]) - np.std(ABfrac1[cut1])
        mean2[i] = np.mean(ABfrac2[cut2])
        upper2[i] = np.mean(ABfrac2[cut2]) + np.std(ABfrac2[cut2])
        lower2[i] = np.mean(ABfrac2[cut2]) - np.std(ABfrac2[cut2])
        mean3[i] = np.mean(ABfrac3[cut3])
        upper3[i] = np.mean(ABfrac3[cut3]) + np.std(ABfrac3[cut3])
        lower3[i] = np.mean(ABfrac3[cut3]) - np.std(ABfrac3[cut3])
        mean4[i] = np.mean(ABfrac4[cut4])
        upper4[i] = np.mean(ABfrac4[cut4]) + np.std(ABfrac4[cut4])
        lower4[i] = np.mean(ABfrac4[cut4]) - np.std(ABfrac4[cut4])
        mean5[i] = np.mean(ABfrac5[cut5])
        upper5[i] = np.mean(ABfrac5[cut5]) + np.std(ABfrac5[cut5])
        lower5[i] = np.mean(ABfrac5[cut5]) - np.std(ABfrac5[cut5])
        mean6[i] = np.mean(ABfrac6[cut6])
        upper6[i] = np.mean(ABfrac6[cut6]) + np.std(ABfrac6[cut6])
        lower6[i] = np.mean(ABfrac6[cut6]) - np.std(ABfrac6[cut6])
...
####################################
    ...
    plt.text(9.1,0.9,r'$\rm {\it n}_{halo}\ = \ 10^{-3.25} cm^{-3}$', fontsize = 22)
    plt.text(9.1,0.8,r'$\rm {\it V}_{sat}\ = \ 200\ km\ s^{-1}$', fontsize = 22)
    ...
    if check == 'normal': 
        ...
        #plt.plot(np.log10(ABmstar2), ABfrac2, color = 'Goldenrod', marker = 'o', linestyle = 'None', markersize = 16)
    ...
    plt.text(9.1,0.9,r'$\rm {\it n}_{halo}\ = \ 10^{-3.25} cm^{-3}$', fontsize = 22)
    plt.text(9.1,0.8,r'$\rm {\it V}_{sat}\ = \ 350\ km\ s^{-1}$', fontsize = 22)
    ...
    if check == 'normal':
        ...
        #plt.plot(np.log10(ABmstar4), ABfrac4, color = 'Goldenrod', marker = 'o', linestyle = 'None', markersize = 16)
    ...
    if check == 'normal':
        ...
        #plt.plot(np.log10(ABmstar5), ABfrac5, color = 'Goldenrod', marker = 'o', linestyle = 'None', markersize = 16)
    ...
    plt.text(9.1,0.9,r'$\rm {\it n}_{halo}\ = \ 10^{-3.25} cm^{-3}$', fontsize = 22)
    plt.text(9.1,0.8,r'$\rm {\it V}_{sat}\ = \ 450\ km\ s^{-1}$', fontsize = 22)
...
###################################################
    ...
    #if check == 'normal':
        #plt.savefig('RPS_AM_6panel.pdf')

    #else:
        #plt.savefig('RPS_AM_6panel_hist.pdf')
