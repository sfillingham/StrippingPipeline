...
###################################################
    ...
    if check == 'normal':
        plt.savefig('RPS_AM_3panel_KH'+np.str(tq)+'Gyr.pdf')

    elif check == 'kh_hist':
        plt.savefig('RPS_AM_3panel_KHonly_hist'+np.str(tq)+'Gyr_slide.pdf')

    else:
        plt.savefig('RPS_AM_3panel_KH_hist'+np.str(tq)+'Gyr_slide.pdf')
