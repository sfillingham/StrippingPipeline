...
def work(check):
    ...
    ABdata1 = Table.read('modeldata/RPS_strippedfrac_hot40_v200_Model.dat', format = 'ascii')
    ABmstar1 = np.array(ABdata1['Mstar'])
    ABfrac1 = np.array(ABdata1['NFW'])

    ABdata2 = Table.read('modeldata/RPS_strippedfrac_hot40_v250_Model.dat', format = 'ascii')
    ABmstar2 = np.array(ABdata2['Mstar'])
    ABfrac2 = np.array(ABdata2['NFW'])

    ABdata3 = Table.read('modeldata/RPS_strippedfrac_hot40_v300_Model.dat', format = 'ascii')
    ABmstar3 = np.array(ABdata3['Mstar'])
    ABfrac3 = np.array(ABdata3['NFW'])

    ABdata4 = Table.read('modeldata/RPS_strippedfrac_hot35_v200_Model.dat', format = 'ascii')
    ABmstar4 = np.array(ABdata4['Mstar'])
    ABfrac4 = np.array(ABdata4['NFW'])

    ABdata5 = Table.read('modeldata/RPS_strippedfrac_hot35_v250_Model.dat', format = 'ascii')
...
###################################################
    ...
    if check == 'normal':
        plt.savefig('RPS_AM_6panel_model.pdf')

    else:
        plt.savefig('RPS_AM_6panel_hist_model.pdf')
